...
public class List {
	 ...
	 * 
	 * .A interface List fornece métodos úteis para adicionar elementos em posições específicas,
	 * remover ou substituir elementos com base no índice e obter sublistas usando índices.
	 * 
